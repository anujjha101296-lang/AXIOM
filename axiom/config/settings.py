...
class AxiomSettings(BaseSettings):
    ...
    require_auth_for_experiment_routes: bool = Field(
        default=False,
        description="Require bearer token for /experiments/* (recommended in production)",
    )
    require_auth_for_frce_routes: bool = Field(
        default=False,
    ...
    require_auth_for_workflow_routes: bool = Field(
        default=False,
        description="Require bearer token for /workflows/* (recommended in production)",
    )
    require_auth_for_vfactory_routes: bool = Field(
        default=False,
        description="Require bearer token for /vfactory/* (recommended in production)",
    )
