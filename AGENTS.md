...
AXIOM is a **self-improving research organization**. Do not work in "prompt → done → next" mode.
...
3. `.axiom/OPERATING_SYSTEM.md` — Continuous Evolution Loop and seven layers
4. `AXIOM_STATE.md` — honest system snapshot
5. `.axiom/CURRENT_STATE.md` and `.axiom/TASK_QUEUE.md`
6. The relevant domain contract (`ENGINEERING.md`, `RESEARCH.md`, `PRODUCT.md`, etc.)
...
2. Update `AXIOM_STATE.md`, `CURRENT_STATE.md`, `TASK_QUEUE.md`, and `MEMORY.md` as appropriate
3. Commit focused changes and push; verify the remote contains the commit

Do not overwrite unrelated uncommitted work. Human approval is required for the external or irreversible actions specified in `.axiom/CONSTITUTION.md`.
