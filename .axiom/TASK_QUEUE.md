...
| 4 | S1-SCI-006 | Persist and stream research lifecycle events incrementally. | S1-SCI-004 | Each state transition is recorded and the workspace can observe run progress without waiting for completion. | **Next** |
